...
CREATE TABLE `buyer` (
  ...
  `registerCommercialNumber` varchar(45) DEFAULT NULL,
  `taxIdentificationNumber` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `enterprise` (
  ...
  `taxIdentificationNumber` int(11) NOT NULL,
  `registerCommercialNumber` varchar(45) NOT NULL,
...
--
ALTER TABLE `buyer`
  ADD PRIMARY KEY (`firstName`,`lastName`,`birthDay`),
